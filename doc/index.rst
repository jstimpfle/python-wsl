...
Note that in the last line, we follow an autogenerated foreign key reference.
...
.. code:: python3
    ...
    for person in db['person']:
        print(person)
    for parent in db['parent']:
        print(parent, 'is a parent of', parent.ref_Person1OfParent)
...
.. code:: python3
    ...
    for chunk in wsl.format_db(db, inline_schema=True):
        print(chunk, end='')
